      ...
      <div className="mb-6 flex items-center justify-between">
        <div>
          ...
          <p className="text-slate-400 text-sm mt-1">
            {q ? (
              <>
                <span className="text-slate-300">{captions.length}</span> results for{' '}
                ...
                <tr key={c.id} className="hover:bg-slate-700/30">
                  <td className="px-4 py-3 max-w-sm">
                    <p className="text-slate-200 text-sm line-clamp-2">
                      {c.content ?? <span className="text-slate-600">(empty)</span>}
                    </p>
                  </td>
                  <td className="px-4 py-3 text-slate-400 text-sm whitespace-nowrap">{author}</td>
                  ...
                  <td className="px-4 py-3">
                    <div className="flex flex-col gap-1">
                      ...
                      {c.is_featured && (
                        <span className="text-xs px-2 py-0.5 rounded font-medium bg-amber-900/50 text-amber-300 w-fit">
                          ⭐ Featured
                        </span>
                      )}
                    </div>
